...
#     s1 = PotentialSite(specie="H", distance=1.999, potential=10, pc_potential=None)
#     s2 = PotentialSite(specie="He", distance=2.0001, potential=15, pc_potential=2)
#     s3 = PotentialSite(specie="He", distance=3.0, potential=20, pc_potential=3)
#
#     return GkfoCorrection(efnv_correction=efnv_correction,
#                           additional_charge=1,
#                           pc_2nd_term=10.0,
#                           sites=[s1, s2, s3],
...
#     assert gkfo_correction.pc_1st_term == 1.0 * 2 / 10 * 1 + 10.0
#
#
